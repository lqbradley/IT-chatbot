...
async function determineRestaurant(message, session, restaurantData, prevRestaurantChoices) {
    ...
    console.log(`Current requirements ${restaurantData}`);
    ...
    switch (session.stage) {
        ...
        case 13:
            if (intent === "yes") {
                ...
                response = "Please respond with yes or no. The specified dish can be inputted after";
            }
            break;
        case 14:
        ...
        case 18:
            if (intent === "yes") {
                ...
                if (selectedRestaurants.length > 0) {
                    response = `No problem. Here are a list of restaurants that meet your criteria. 
                                ${selectedRestaurants} 
                ...
                response = "Please confirm your restaurant choices";
            } break;
        case 19:
        ...
        case 20:
            if (intent === "yes") {
                ...
                response = "Please respond to this question with yes or no"
            } break;
        case 21:
            if (intent === "yes") {
                prevRestaurantChoices = session.restaurantChoices
                restaurantData = {}
                session.stage = 0;
                session.failCount = 0;
                understood = true;
    ...
    if (session.history.length > 20) {
        ...
        response += " We've been chatting for a while. Would you like to continue or start over?";
    }
